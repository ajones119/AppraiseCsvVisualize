...
export type CellType = "string" | "date" | "number" | "boolean" | "status" | "garage";
...
export const DEFAULT_IMPORT_MAP: CSVImportMap[] = [
    ...
    { key: 'garageDescription', name: 'Garage Parking Description' , type: "string"},
    { key: 'hasPool', name: 'Has Pool', type: "boolean"},
    { key: 'poolType', name: 'Pool Type' , type: "string"},
]

export const parseCSVRowIntoMLSDataEntry = (row: string[], importOrder = DEFAULT_IMPORT_MAP): MLSDataEntry => {
